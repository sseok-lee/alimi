...
export const mockBenefits: BenefitResponse[] = [
  ...
  },
  {
    ...
    category: '복지서비스',
    description:
      '세 자녀 이상 다자녀 가정에 양육비를 지원합니다. 셋째 자녀부터 월 10만원씩 지급됩니다.',
    estimatedAmount: '월 10만원 (셋째 이상)',
    eligibility: {
      family: '세 자녀 이상',
      age: '만 0~7세 자녀',
    },
  ...
  },
  {
    ...
    category: '복지서비스',
    description:
      '저소득 한부모가족의 만 18세 미만 자녀에게 양육비를 지원합니다. 월 20만원씩 지급됩니다.',
    estimatedAmount: '월 20만원',
    eligibility: {
      family: '한부모가족',
      income: '기준 중위소득 60% 이하',
      age: '만 18세 미만 자녀',
  ...
  },
  {
    ...
    category: '복지서비스',
    description:
      '신체적, 정신적 장애로 혼자 일상생활이 어려운 장애인에게 활동지원 서비스를 제공합니다.',
    estimatedAmount: '월 최대 122시간 지원',
    eligibility: {
      disability: '장애인복지법상 등록 장애인',
      grade: '장애등급 1~6급',
    },
    link: 'https://www.ableservice.or.kr',
    minAge: 6,
    maxAge: 64,
    minIncome: 0,
    maxIncome: 999999999,
  ...
  },
  {
    ...
    category: '복지서비스',
    description:
      '첫째 200만원, 둘째 500만원, 셋째 이상 1,000만원의 출산 지원금을 지급합니다.',
    estimatedAmount: '첫째 200만원, 둘째 500만원, 셋째 이상 1,000만원',
    eligibility: {
      life: '출산 또는 입양',
      age: '영유아 자녀',
    },
